package com.bootcamp.CRUDTask.resources;
...
import com.bootcamp.CRUDTask.services.ClientService;
...
public class ClientResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Void> update(@PathVariable Long id, @RequestBody ClientDTO dto){
